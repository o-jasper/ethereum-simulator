...
module.exports = function(settings) {
  ...
  function prepareTemplates() {
    var appTemplates = {
      contract       : templateCompiled(fs.readFileSync(__templateFiles + 'contract.hbs')),
      transaction    : templateCompiled(fs.readFileSync(__templateFiles + 'transaction.hbs')),
      wallet         : templateCompiled(fs.readFileSync(__templateFiles + 'wallet.hbs')),
      new_transaction: templateCompiled(fs.readFileSync(__templateFiles + 'new_transaction.hbs')),
      new_contract   : templateCompiled(fs.readFileSync(__templateFiles + 'new_contract.hbs')),
      new_wallet     : templateCompiled(fs.readFileSync(__templateFiles + 'wallet.hbs')),
      about          : templateCompiled(fs.readFileSync(__templateFiles + 'about.hbs'))
    }
    return appTemplates
  }
