...
module.exports = function(settings) {
  ...
  function templateCompiled(input) {
    return Handlebars.compile(input.toString());
  }

  function prepareTemplates() {
    var appTemplates = {
      contract       : templateCompiled(fs.readFileSync('./templates/default/contract.hbs')),
      transaction    : templateCompiled(fs.readFileSync('./templates/default/transaction.hbs')),
      wallet         : templateCompiled(fs.readFileSync('./templates/default/wallet.hbs')),
      new_transaction: templateCompiled(fs.readFileSync('./templates/default/new_transaction.hbs')),
      new_contract   : templateCompiled(fs.readFileSync('./templates/default/new_contract.hbs')),
      new_wallet     : templateCompiled(fs.readFileSync('./templates/default/wallet.hbs')),
      about          : templateCompiled(fs.readFileSync('./templates/default/about.hbs'))
    }
    return appTemplates
  }
